                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#modalEditBeasiswa<?php echo $t_beasiswa['idBeasiswa']; ?>" data-bs-toggle="modal" title="Edit" class="btn btn-xs btn-primary"><i class="fa fa-edit" style="text-align: center;"></i></a>
                                                    <a href="#modalDeleteBeasiswa<?php echo $t_beasiswa['idBeasiswa']; ?>" data-bs-toggle="modal" title="Hapus" class="btn btn-xs btn-danger"><i class="fa fa-trash" style="text-align: center;"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
